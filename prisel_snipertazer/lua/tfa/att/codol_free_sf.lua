...
ATTACHMENT.Name = "Skyfire Finish"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "Silver", "Pink Accents" }
ATTACHMENT.Icon = "entities/tfa_ins2_codol_free_sf.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
