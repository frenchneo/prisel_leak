hook.Add("PlayerCanHearPlayersVoice","Ekali:MegaphoneChangeDistanceVoice",function(lis,tal)
  if lis == tal then return end
  local wep = tal:GetActiveWeapon()
  if not (IsValid(wep) and wep:GetClass() == "ekali_megaphone") then return end
